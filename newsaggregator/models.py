...
class Entry(models.Model):
    ...
    mod_date = models.DateTimeField(verbose_name=_("Date Modified"), null=True, blank=True)
    guid = models.CharField(maxlength=200, unique=True, db_index=True, verbose_name=_("Globally Unique Identifier"), blank=True, null=True)
